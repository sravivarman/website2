...
{{< admonition type=tip title="2025–2026" open=true >}}
- Projects to be updated
{{< /admonition >}}

{{< admonition type=info title="2024–2025" open=true >}}
- Projects to be updated
{{< /admonition >}}

{{< admonition type=success title="2023–2024" open=true >}}
- **Analysis and simulation of boost–flyback converter for renewable energy integration** [Publication](#pub-boost-flyback)
{{< /admonition >}}

{{< admonition type=abstract title="2022–2023" open=true >}}
- **Simulation of modified switched capacitor–inductor based boost converter with reduced switch voltage stress for PV systems** (PG)
- **Comparative analysis of DC–DC converters used in fuel cell vehicles**
- **Switched quasi Z-source DC–DC converter for photovoltaic systems** [Publication](#pub-zsource-pv)
{{< /admonition >}}

{{< admonition type=warning title="2020–2021" open=true >}}
- **Monitoring of solar charge controller using IoT** (UG)
- **Single-switch transformer-less high-gain DC–DC converter for automotive applications** (UG)
- **IoT-based home automation using voice control** (UG)
- **Non-isolated high-gain triple-port DC–DC buck–boost converter for photovoltaic applications** (UG)
- **Simulation of high-gain boost–Ćuk DC–DC converter for fuel-cell-powered electric vehicle** (PG)
{{< /admonition >}}

{{< admonition type=question title="2019–2020" open=true >}}
- **Arduino-based battery management system for electric vehicles** (UG)
- **Single-switch high step-up boost converter based on a voltage multiplier** (UG)
{{< /admonition >}}

{{< admonition type=note title="2018–2019" open=true >}}
- **Implementation of low-power off-grid solar inverter for residential applications** (UG)
- **Simulation of a nine-level inverter using reverse voltage topology** (UG)
{{< /admonition >}}

{{< admonition type=failure title="2017–2018" open=true >}}
- **Non-isolated power converter for battery systems in electric vehicles** (UG)
{{< /admonition >}}

<<<<<<< HEAD
{{< admonition type=abstract title="2015–2016" open=true >}}
- **Voltage balancing in diode-clamped multilevel inverter using boost converter** (PG)
{{< /admonition >}}
=======
<details>
...
<details>
<summary><strong>2020–2021</strong></summary>

<ul>
  <li class="project-item" data-tags="PV,IoT">
    <strong>Monitoring of solar charge controller using IoT</strong> (UG)
  </li>
  <li class="project-item" data-tags="EV,Converter">
    <strong>Single-switch transformer-less high-gain DC–DC converter for automotive applications</strong> (UG)
  </li>
  <li class="project-item" data-tags="IoT">
...
<details>
<summary><strong>2019–2020</strong></summary>

<ul>
  <li class="project-item" data-tags="EV">
    <strong>Arduino-based battery management system for electric vehicles</strong> (UG)
  </li>
  <li class="project-item" data-tags="Converter">
    <strong>Single-switch high step-up boost converter based on a voltage multiplier</strong> (UG)
  </li>
</ul>
...
<details>
<summary><strong>2018–2019</strong></summary>

<ul>
  <li class="project-item" data-tags="PV,Inverter">
    <strong>Implementation of low-power off-grid solar inverter for residential applications</strong> (UG)
  </li>
  <li class="project-item" data-tags="Inverter">
    <strong>Simulation of a nine-level inverter using reverse voltage topology</strong> (UG)
  </li>
</ul>
...
<ul>
  <li class="project-item" data-tags="EV,Converter">
    <strong>Non-isolated power converter for battery systems in electric vehicles</strong> (UG)
  </li>
</ul>
...
<details>
<summary><strong>2015–2016</strong></summary>
...
{{< admonition type=success title="Recent Publications" open=true >}}
...
<a id="pub-zsource-pv"></a>
- Ravivarman S. et al., *Switched Quasi Z-Source DC–DC Converter for Photovoltaic Systems*, CONIT, 2023.
{{< /admonition >}}

{{< admonition type=tip title="For Prospective Students" open=true >}}
If you're interested in pursuing research in power electronics, renewable energy, or electric vehicles, feel free to reach out to discuss potential projects and collaboration opportunities!
{{< /admonition >}}
